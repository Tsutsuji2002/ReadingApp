...
const PostNovelScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Dispatch postNovel action to save the novel in Firestore
      await dispatch(postNovel(novelData));
      Alert.alert('Success', 'Novel posted successfully!');
      navigation.navigate('AddChapterScreen', { novelData });
